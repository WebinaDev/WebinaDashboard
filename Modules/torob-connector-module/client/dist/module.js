...
var M = globalThis?.document ? r.useLayoutEffect : () => {}, ne = r.useInsertionEffect || M;
...
var oe = (e) => {
	let { present: t, children: n } = e, i = P(t), a = typeof n == "function" ? n({ present: i.isPresent }) : r.Children.only(n), o = C(i.ref, se(a));
	return typeof n == "function" || i.isPresent ? r.cloneElement(a, { ref: o }) : null;
};
oe.displayName = "Presence";
function P(e) {
	let [t, n] = r.useState(), i = r.useRef(null), a = r.useRef(e), o = r.useRef("none"), [s, c] = ae(e ? "mounted" : "unmounted", {
		mounted: {
			UNMOUNT: "unmounted",
...
var L = "Checkbox", [le, ue] = k(L), [de, R] = le(L);
function fe(e) {
	let { __scopeCheckbox: t, checked: n, children: i, defaultChecked: a, disabled: o, form: s, name: c, onCheckedChange: l, required: u, value: d = "on", internal_do_not_use_render: f } = e, [p, h] = N({
		prop: n,
		defaultProp: a ?? !1,
		onChange: l,
		caller: L
...
var ve = "CheckboxBubbleInput", ye = r.forwardRef(({ __scopeCheckbox: e, ...t }, n) => {
	let { control: i, hasConsumerStoppedPropagationRef: a, checked: o, defaultChecked: s, required: c, disabled: l, name: u, value: d, form: f, bubbleInput: p, setBubbleInput: h } = R(ve, e), g = C(n, h), _ = ce(o), v = I(i);
	r.useEffect(() => {
		let e = p;
		if (!e) return;
...
var Se = "Label", Ce = r.forwardRef((e, t) => /* @__PURE__ */ m(O.label, {
	...e,
	ref: t,
	onMouseDown: (t) => {
...
function Vn({ platform: r, titleKey: i, subtitleKey: a, feedPlatform: o = !1, embedded: s = !1 }) {
		...
		children: [
						...
						children: [
							...
							Object.entries(O).map(([e, t]) => Rn.has(e) ? /* @__PURE__ */ h("div", {
								...
								children: [/* @__PURE__ */ m(Z, {
									...
									className: "w-full",
									value: String(t ?? ""),
									onChange: (t) => k(e, t.target.value)
								})]
							}, e)),
							Object.keys(O).length === 0 && !o ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ h("div", {
								className: "space-y-1",
								children: [/* @__PURE__ */ m(Z, {
									className: "text-xs",
									...
									className: "w-full",
									value: "",
									onChange: (e) => k("base_url", e.target.value)
								})]
							}), /* @__PURE__ */ h("div", {
								className: "space-y-1",
								children: [/* @__PURE__ */ m(Z, {
									...
									className: "w-full",
									value: "",
									onChange: (e) => k("token", e.target.value)
								})]
							})] }) : null
						]
					}),
			...
			o && C.data?.url ? /* @__PURE__ */ h("section", {
				...
				children: [
					...
					C.data.products_v3_url ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m("h3", {
						className: "pt-2 text-sm font-medium",
						children: g("wnc.torobProductsV3Url")
					}), /* @__PURE__ */ m("code", {
						className: "bg-muted block break-all rounded-xl p-2 text-xs",
						children: C.data.products_v3_url
					})] }) : null,
					C.data.products_legacy_url ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m("h3", {
						className: "pt-2 text-sm font-medium",
						children: g("wnc.torobProductsLegacyUrl")
					}), /* @__PURE__ */ m("code", {
						className: "bg-muted block break-all rounded-xl p-2 text-xs",
						children: C.data.products_legacy_url
					})] }) : null,
					...
					C.data.orders_list_legacy_url ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m("h3", {
						className: "pt-2 text-sm font-medium",
						children: g("wnc.torobOrdersListLegacyUrl")
					}), /* @__PURE__ */ m("code", {
						className: "bg-muted block break-all rounded-xl p-2 text-xs",
						children: C.data.orders_list_legacy_url
					})] }) : null,
					C.data.actions_url ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m("h3", {
						className: "pt-2 text-sm font-medium",
						children: g("wnc.torobActionsUrl")
					}), /* @__PURE__ */ m("code", {
						className: "bg-muted block break-all rounded-xl p-2 text-xs",
						children: C.data.actions_url
					})] }) : null,
					C.data.set_token_url ? /* @__PURE__ */ h(p, { children: [/* @__PURE__ */ m("h3", {
						className: "pt-2 text-sm font-medium",
						children: g("wnc.torobSetTokenUrl")
					}), /* @__PURE__ */ m("code", {
						className: "bg-muted block break-all rounded-xl p-2 text-xs",
						children: C.data.set_token_url
					})] }) : null,
...
//#endregion
//#region ../Modules/torob-connector-module/client/pages/TorobConnectorPage.tsx
function Hn() {
...
//#endregion
//#region ../Modules/torob-connector-module/client/module-entry.tsx
var Un = { "settings/shop/torob": Hn }, Wn = { routes: Un };
//#endregion
export { Wn as default, Un as routes };
