...
class JobsRunner
{
    private const GLOBAL_RUNNER_LAST_RUN_OPTION = 'wnc_basalam_jobs_runner_last_run';
    ...
    {
        if ( class_exists( '\\WNC_Basalam_Runtime', false ) && ! \WNC_Basalam_Runtime::owns_runtime() ) {
            return;
        }
        if ( apply_filters( 'wnc_basalam_skip_jobs_runner', false ) ) {
            return;
        }
