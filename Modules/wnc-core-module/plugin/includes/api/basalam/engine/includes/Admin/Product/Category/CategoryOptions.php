...
namespace WncBasalam\Admin\Product\Category;
...
class CategoryOptions
{
    ...
    {
        $this->db = $wpdb;
        $this->tableName = $wpdb->prefix . 'wnc_basalam_map_options';
    }

    public function add($woo_name, $wnc_basalam_name)
    {
        if (empty($woo_name) || empty($wnc_basalam_name)) return false;
        ...
        $result = $this->db->insert(
            ...
            [
                'woo_name'          => $woo_name,
                'wnc_basalam_name' => $wnc_basalam_name,
            ],
            ['%s', '%s']
        );
    ...
    public function delete(string $woo_name, string $wnc_basalam_name): array
    {
        if (empty($woo_name) || empty($wnc_basalam_name)) {
            return [
                'success'     => false,
