...
class Activator
{
    ...
    public static function activateDb()
    {
        ...
        $table_name_payments = $wpdb->prefix . 'wnc_basalam_payments';
        $table_name_options = $wpdb->prefix . 'wnc_basalam_map_options';
        $table_name_uploaded_media = $wpdb->prefix . 'wnc_basalam_uploaded_media';
        $table_name_debug_logs = $wpdb->prefix . 'wnc_basalam_debug_logs';
        $table_name_discount_tasks = $wpdb->prefix . 'wnc_basalam_discount_tasks';
        $table_name_category_mappings = $wpdb->prefix . 'wnc_basalam_category_mappings';
        $table_name_jobs_manager = $wpdb->prefix . 'wnc_basalam_job_manager';
        ...
        $sql_category_mappings = "CREATE TABLE $table_name_category_mappings (
            ...
            basalam_category_level1 int(11) DEFAULT NULL,
            basalam_category_level2 int(11) DEFAULT NULL,
            basalam_category_level3 int(11) DEFAULT NULL,
            basalam_category_name varchar(255) NOT NULL,
            created_at datetime DEFAULT CURRENT_TIMESTAMP,
            updated_at datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            PRIMARY KEY  (id),
            UNIQUE KEY woo_category_unique (woo_category_id),
            KEY basalam_category_level1_idx (basalam_category_level1)
        ) $charset_collate;";
