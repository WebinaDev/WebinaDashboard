...
use WncBasalam\Services\Products\FetchCommission;
...
class PriceService
{
    ...
    {
        $priceField = wncBasalamSettings()->getSettings(SettingsConfig::PRODUCT_PRICE_FIELD);
    ...
    private function applyPriceCalculations(float $price, array $categoryIds, $product): ?int
    {
        ...
        $roundMode = wncBasalamSettings()->getSettings(SettingsConfig::ROUND_PRICE);
    ...
    private function getPriceChangeValue($product): string
    {
        ...
        return (string) (PriceAdjustment::normalize(wncBasalamSettings()->getSettings(SettingsConfig::PRICE_CHANGE_VALUE)) ?? '0');
    }
