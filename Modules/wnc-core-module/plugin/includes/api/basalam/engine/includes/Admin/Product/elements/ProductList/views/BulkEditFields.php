        ...
        <div class="sync-basalam-bulk-edit__fields">
            <div class="sync-basalam-bulk-edit__section sync-basalam-bulk-edit__section--type">
                <label class="alignleft sync-basalam-bulk-edit__field">
                    <?php echo wp_kses_post(\WncBasalam\Admin\Components\CommonComponents::renderLabelWithTooltip('نوع محصول باسلام', 'اگر این گزینه را فعال کنید، محصول در باسلام به صورت محصول واحددار ارسال می‌شود و می‌توانید واحد و مقدار آن را مشخص کنید.')); ?>
                    <select name="wnc_basalam_bulk_product_type_action" class="sync-basalam-bulk-select basalam-select basalam-font-pelak-12">
                ...
                <div class="sync-basalam-bulk-type-fields">
                    <label class="alignleft sync-basalam-bulk-edit__field">
                        ...
                        <select name="wnc_basalam_bulk_product_unit" class="sync-basalam-bulk-select basalam-select basalam-font-pelak-12">
                    ...
                    <label class="alignleft sync-basalam-bulk-edit__field">
                        ...
                        <input type="number" name="wnc_basalam_bulk_product_value" min="1" step="1" value="1" class="basalam-input basalam-font-pelak-12">
                    </label>
                </div>
            </div>
            ...
            <div class="sync-basalam-bulk-edit__section sync-basalam-bulk-edit__section--wholesale">
                <label class="alignleft sync-basalam-bulk-edit__field">
                    <?php echo wp_kses_post(\WncBasalam\Admin\Components\CommonComponents::renderLabelWithTooltip('محصول عمده', 'با فعال کردن این گزینه، محصولات انتخاب‌شده در باسلام با حالت عمده ثبت یا به‌روزرسانی می‌شوند.')); ?>
                    <select name="wnc_basalam_bulk_wholesale_action" class="sync-basalam-bulk-select basalam-select basalam-font-pelak-12">
                        <option value="keep">بدون تغییر</option>
                        <option value="yes">فعال</option>
                        <option value="no">غیرفعال</option>
                    </select>
            ...
            <div class="sync-basalam-bulk-edit__section sync-basalam-bulk-edit__section--price-change basalam-form-group basalam-form-group-full basalam-p">
                ...
                <div class="sync-basalam-bulk-edit__field sync-basalam-bulk-price-change-value">
                    ...
                    <div class="basalam-flex-end-gap-4 basalam-margin-top-8">
                        <input type="checkbox" id="sync-basalam-bulk-toggle-percentage" class="toggle-percentage" name="wnc_basalam_bulk_toggle_percentage">
                        <label class="basalam-font-10" for="sync-basalam-bulk-toggle-percentage">کارمزد دسته‌بندی</label>
                    </div>
                    <input type="hidden" id="sync-basalam-bulk-price-change-value" data-role="price-change-hidden" name="wnc_basalam_bulk_price_change_value" value="">
                </div>
            </div>
