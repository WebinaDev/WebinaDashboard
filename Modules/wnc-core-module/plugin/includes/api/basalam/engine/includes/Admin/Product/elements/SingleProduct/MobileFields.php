...
class MobileFields
{
    public static function renderCheckbox()
    {
        ...
        wp_nonce_field('wnc_basalam_save_mobile_fields_action', '_sync_basalam_mobile_fields_nonce');
    ...
    public static function saveCheckbox($postId)
    {
        if (
            ...
            || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['_sync_basalam_mobile_fields_nonce'])), 'wnc_basalam_save_mobile_fields_action')
        ) {
            return;
        }
