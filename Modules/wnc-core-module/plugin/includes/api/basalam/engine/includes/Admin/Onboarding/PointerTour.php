...
namespace WncBasalam\Admin\Onboarding;

class PointerTour
{
    public static function markPointerOnboardingCompleted(): void
    {
        check_ajax_referer('wnc_basalam_mark_pointer_onboarding_completed', 'nonce', true);

        if (!current_user_can('manage_options')) {
            wp_send_json_error(['message' => 'دسترسی مجاز نیست.'], 403);
        }

        update_option('wnc_basalam_pointer_onboarding_completed', true, false);
    ...
    public static function shouldLoadPointerTour(string $hook): bool
    {
        ...
        $pointerOnboardingStatus = get_option('wnc_basalam_pointer_onboarding_completed', null);
    ...
    {
        return [
            'nonce' => wp_create_nonce('wnc_basalam_mark_pointer_onboarding_completed'),
            'completeAction' => 'wnc_basalam_mark_pointer_onboarding_completed',
    ...
    private static function getPointerSteps(): array
    {
        return [
            ...
            [
                'selector' => '#sync-wnc_basalam-onboarding-status',
                'content' => '
                    <div class="sync-basalam-pointer-step">
            ...
            [
                'selector' => '#sync-wnc_basalam-onboarding-products',
                'content' => '
                    <div class="sync-basalam-pointer-step">
            ...
            [
                'selector' => '#sync-wnc_basalam-onboarding-orders',
                'content' => '
                    <div class="sync-basalam-pointer-step">
            ...
            [
                'selector' => '#sync-wnc_basalam-onboarding-settings',
                'content' => '
                    <div class="sync-basalam-pointer-step">
            ...
            [
                'selector' => '#sync-wnc_basalam-onboarding-advanced-settings',
                'content' => '
                    <div class="sync-basalam-pointer-step">
