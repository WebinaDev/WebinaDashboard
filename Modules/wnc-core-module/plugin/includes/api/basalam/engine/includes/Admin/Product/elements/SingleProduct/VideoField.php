...
namespace WncBasalam\Admin\Product\elements\SingleProduct;

use WncBasalam\Services\Products\VideoSourceResolver;
...
class VideoField
{
    private const META_BOX_ID = 'wnc_basalam_product_video_box';
    ...
    public static function render(): void
    {
        ...
        wp_nonce_field('wnc_basalam_save_video_field_action', '_wnc_basalam_video_field_nonce');
    ...
    {
        if (
            !isset($_POST['_wnc_basalam_video_field_nonce'])
            || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['_wnc_basalam_video_field_nonce'])), 'wnc_basalam_save_video_field_action')
        ) {
            return;
        }
