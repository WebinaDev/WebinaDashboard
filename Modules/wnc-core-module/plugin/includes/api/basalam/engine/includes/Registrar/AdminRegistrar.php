...
use WncBasalam\Actions\RegisterActions;
use WncBasalam\Admin\Pages;
use WncBasalam\Registrar\Contracts\RegistrarInterface;
use WncBasalam\Admin\Product\elements\ProductList\StatusColumn;
use WncBasalam\Admin\Product\elements\ProductList\MetaBox;
use WncBasalam\Admin\Product\elements\ProductList\BulkEdit;
use WncBasalam\Admin\Product\elements\SingleProduct\Tab;
use WncBasalam\Admin\Product\elements\SingleProduct\VideoField;
use WncBasalam\Admin\Product\elements\ProductList\Filter;
use WncBasalam\Admin\Product\elements\ProductList\Actions;
use WncBasalam\Admin\Order\OrderColumn;
use WncBasalam\Admin\Order\OrderMetaBox;
use WncBasalam\Admin\Components\OrderPageComponents;
use WncBasalam\Admin\Order\OrderStatuses;
use WncBasalam\Admin\Product\Operations\ConnectProduct;
use WncBasalam\Admin\Announcement\AnnouncementCenter;
use WncBasalam\Admin\Onboarding\PointerTour;
use WncBasalam\Services\Products\DuplicateConnectionReport;
...
use WncBasalam\Utilities\ChatWidget;
use WncBasalam\Utilities\TicketFlashNotice;
use WncBasalam\Admin\Settings\SettingsPageHandler;
use WncBasalam\Admin\Settings\OAuthCallbackHandler;
use WncBasalam\Admin\FinancialManagement\Menu as FinancialManagementMenu;
use WncBasalam\Admin\FinancialManagement\BalanceSettlement;
use WncBasalam\Admin\FinancialManagement\FinancialManagementHistory;
...
class AdminRegistrar implements RegistrarInterface
{
    public static function register(): void
    {
        ...
        \add_action('admin_action_wnc_basalam_bulk_edit', [$bulkEdit, 'save']);
        ...
        add_action('wp_ajax_wnc_basalam_mark_pointer_onboarding_completed', [PointerTour::class, 'markPointerOnboardingCompleted']);
        ...
        add_action('wp_ajax_basalam_calculate_tasks_per_minute', function () {
            ...
            $monitor = wncBasalamContainer()->get(SystemResourceMonitor::class);
    ...
    public static function adminEnqueueScripts($hook = '')
    {
        ...
        $adminScriptPath = wncBasalamPlugin()->pluginPath() . '/assets/js/admin.js';
        ...
        $ticketScriptPath = wncBasalamPlugin()->pluginPath() . '/assets/js/ticket.js';
