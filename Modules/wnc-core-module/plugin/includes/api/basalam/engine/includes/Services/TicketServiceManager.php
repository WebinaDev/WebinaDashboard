...
use WncBasalam\Services\Hamsalam\FetchHamsalamToken;
use WncBasalam\Services\Hamsalam\FetchHamsalamBusinessId;

use WncBasalam\Services\Ticket\FetchAllTickets;
use WncBasalam\Services\Ticket\FetchTicket;
use WncBasalam\Services\Ticket\FetchTicketSubjects;
use WncBasalam\Services\Ticket\CreateTicket;
use WncBasalam\Services\Ticket\CreateTicketItem;
use WncBasalam\Services\Ticket\UploadTicketMedia;
use WncBasalam\Services\Ticket\UpsertTicketSiteAccess;
...
class TicketServiceManager
{
    ...
    {
        $settings = (array) wncBasalamSettings()->getSettings();
