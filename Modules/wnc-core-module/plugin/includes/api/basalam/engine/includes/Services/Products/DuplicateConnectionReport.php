...
{
    public const OPTION = 'wnc_basalam_duplicate_connection_report';
    public const DISMISS_QUERY_ARG = 'wnc_basalam_dismiss_duplicate_report';
    public const DISMISS_NONCE = 'wnc_basalam_dismiss_duplicate_report_nonce';
    ...
    public static function render(): void
    {
        ...
        require wncBasalamPlugin()->templatePath('notifications/DuplicateConnectionAlert.php');
    }
