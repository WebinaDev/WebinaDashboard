...
class TypeFields
{
    public static function renderCheckbox()
    {
        ...
        wp_nonce_field('wnc_basalam_save_product_type_action', '_wnc_basalam_product_type_nonce');
    ...
    {
        if (
            !isset($_POST['_wnc_basalam_product_type_nonce'])
            || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['_wnc_basalam_product_type_nonce'])), 'wnc_basalam_save_product_type_action')
        ) {
            return;
        }
