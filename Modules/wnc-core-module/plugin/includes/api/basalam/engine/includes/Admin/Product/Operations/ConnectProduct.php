...
use WncBasalam\Services\Products\ConnectSingleProductService;
use WncBasalam\Services\Products\AutoConnectProducts;
use WncBasalam\JobManager;
use WncBasalam\Admin\Components\SingleProductPageComponents;
...
class ConnectProduct
{
    public function handleConnectProduct(): array
    {
        ...
        if (SettingsManager::isProductUpdateSelectionValid()) {
            $job_manager = wncBasalamContainer()->get(JobManager::class);
