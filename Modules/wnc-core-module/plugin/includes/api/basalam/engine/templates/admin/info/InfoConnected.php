            ...
            <div class="basalam-card">
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" class="Basalam-form">
                    ...
                    <button type="submit" class="basalam-p basalam-danger-button">
                        <img src="<?php echo esc_url(wncBasalamPlugin()->assetsUrl() . '/icons/trash.svg'); ?>" alt="">
                        حذف دسترسی
                    </button>
                </form>
                <?php if (apply_filters('wnc_basalam_show_contact_us', true)): ?>
                    ...
                    <div class="basalam-contact-container basalam-contact-padding-top">
                        <a href="https://t.me/woosalam" target="_blank">
                            <div class="basalam-contact-btn basalam-btn-contact__blue">
                                <img src="<?php echo esc_url(wncBasalamPlugin()->assetsUrl('/images/telegram.png')); ?>" alt="telegram" class="basalam-contact-img-40">
                            </div>
                        </a>
                        <a href="https://www.aparat.com/playlist/20857018" target="_blank">
                            <div class="basalam-contact-btn basalam-btn-contact__red">
                                <img src="<?php echo esc_url(wncBasalamPlugin()->assetsUrl('/images/aparat.png')); ?>" alt="aparat" class="basalam-contact-img-40">
                            </div>
                        </a>
                        <a href="https://wp.hamsalam.ir/help" target="_blank">
                            <div class="basalam-contact-btn basalam-btn-contact__blue">
                                <img src="<?php echo esc_url(wncBasalamPlugin()->assetsUrl('/images/help.svg')); ?>" alt="help page" class="basalam-contact-img-70">
                            </div>
                        </a>
                    </div>
                </div>
