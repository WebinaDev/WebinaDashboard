...
<div class="basalam-dashboard">
    <?php
    require_once(wncBasalamPlugin()->templatePath("products/Popups/AddProduct.php"));
    require_once(wncBasalamPlugin()->templatePath("products/Popups/EditProduct.php"));
    require_once(wncBasalamPlugin()->templatePath("products/Popups/AutoConnect.php"));
    require_once(wncBasalamPlugin()->templatePath("products/sections/Status.php"));
    ?>
    <div class="basalam-action-cards">
        <?php
        require_once(wncBasalamPlugin()->templatePath("products/sections/ProductList.php"));
        require_once(wncBasalamPlugin()->templatePath("orders/sections/OrderManagement.php"));
        require_once(wncBasalamPlugin()->templatePath("products/sections/Settings.php"));
        ?>
    </div>
</div>
