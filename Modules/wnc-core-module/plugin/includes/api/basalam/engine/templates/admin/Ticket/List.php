...
use WncBasalam\Utilities\DateConverter;
...
$base_url = add_query_arg(['page' => 'wnc_basalam_tickets'],admin_url('admin.php'));
...
<div class="basalam-container">
    ...
    <div class="basalam-header basalam-margin-top-17">
        ...
        <div class="basalam-header-data ticket-header-data">
            ...
            <a href="<?php echo esc_url(add_query_arg(['page' => 'wnc_basalam_new_ticket'],admin_url('admin.php'))); ?>"class="basalam-primary-button basalam-p basalam-btn-no-margin-bottom">ایجاد تیکت جدید
            </a>
        </div>
    </div>
</div>
