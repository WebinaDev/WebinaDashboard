...
?>
<div class="wnc_basalam-onboarding-wrapper">
    <div class="wnc_basalam-onboarding">
        ...
        <div class="step-navigation">
            <?php if ($current_step == 1) : ?>
                <a href="<?php echo esc_url(admin_url() . "admin.php?page=wnc_basalam"); ?>"
                    class="basalam-p basalam-skip-link">
                    گذر از مراحل
                </a>
                <a href="<?php echo esc_url(admin_url('admin.php?page=wnc_basalam-onboarding&step=' . ($current_step + 1))); ?>"
