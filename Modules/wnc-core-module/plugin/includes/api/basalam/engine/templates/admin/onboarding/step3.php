...
<div class="step-content step-complete">
    <div class="success-icon-wrapper">
        <img src="<?php echo esc_url(wncBasalamPlugin()->assetsUrl() . 'icons/success.svg'); ?>"
            alt="Success"
    ...
    <div class="celebration-button-wrapper">
        <a href="<?php echo esc_url(admin_url('admin.php?page=wnc_basalam')); ?>" class="basalam-primary-button celebration-button basalam-a">
            رفتن به داشبورد
        </a>
    </div>
</div>