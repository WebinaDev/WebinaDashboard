jQuery(document).ready(function ($) {
  ...
  $(document).on("change", ".category-option", function () {
    if ($(this).is(":checked")) {
      ...
      $("#wnc_basalam_category_attributes")
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          $("#wnc_basalam_category_attributes").html(html);
        ...
        error: function (xhr, status, error) {
          ...
          $("#wnc_basalam_category_attributes").html(message);
        },
      });
    } else {
      $(".basalam-action-button").removeAttr("data-cat-id");
      $("#wnc_basalam_category_attributes").html("");
    }
  });
    ...
    $.ajax({
      ...
      success: function (res) {
        if (res.success) {
          ...
          html += `</div>`;
          $("#wnc_basalam_category_id").html(html);
        } else {
          $("#wnc_basalam_category_id").html(
      ...
      error: function (xhr, status, error) {
        ...
        $("#wnc_basalam_category_id").html(message);
        $btn.prop("disabled", false).text(originalText);
      },
    });
  });
