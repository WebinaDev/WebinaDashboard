...
class WNC_Torob_Order_Status
{
     ...
     * @return void
     */
    public function register_order_status_route(WNC_Torob_Token $validator): void
    {
    ...
    {
        if (!WNC_Torob_Options::isOrderStatusEnabled()) {
    ...
    private function map_order_status(WC_Order $order): string
    {
        ...
        $cancelled_statuses = [
            WNC_Torob_WC_Status_Enum::CANCELLED,
            WNC_Torob_WC_Status_Enum::REFUNDED
        ];
        ...
        switch ($wc_status) {
            case WNC_Torob_WC_Status_Enum::PENDING:
                return WNC_Torob_Status_Enum::WAITING_FOR_USER_PAYMENT;

            case WNC_Torob_WC_Status_Enum::ON_HOLD:
                return WNC_Torob_Status_Enum::WAITING_FOR_SHOP;

            case WNC_Torob_WC_Status_Enum::PROCESSING:
                return WNC_Torob_Status_Enum::PROCESSING;

            case WNC_Torob_WC_Status_Enum::COMPLETED:
                return WNC_Torob_Status_Enum::SHIPPED;

            case WNC_Torob_WC_Status_Enum::CANCELLED:
                return $is_paid ? WNC_Torob_Status_Enum::CANCELED_PAID : WNC_Torob_Status_Enum::CANCELED_UNPAID;

            case WNC_Torob_WC_Status_Enum::REFUNDED:
                return WNC_Torob_Status_Enum::CANCELED_PAID;

            case WNC_Torob_WC_Status_Enum::FAILED:
                return WNC_Torob_Status_Enum::CANCELED_UNPAID;
    ...
    private function generate_order_explanation(WC_Order $order, string $torob_status): string
    {
        ...
        switch ($torob_status) {
            case WNC_Torob_Status_Enum::SHIPPED:
            ...
            case WNC_Torob_Status_Enum::PROCESSING:
            ...
            case WNC_Torob_Status_Enum::WAITING_FOR_USER_PAYMENT:
            ...
            case WNC_Torob_Status_Enum::WAITING_FOR_SHOP:
            ...
            case WNC_Torob_Status_Enum::CANCELED_UNPAID:
            ...
            case WNC_Torob_Status_Enum::CANCELED_PAID:
                $cancel_reason = $order->get_meta(self::META_CANCEL_REASON);
    ...
    public function render_torob_tracking_meta_box($post_or_order): void
    {
        ...
        wp_nonce_field('wnc_torob_tracking_save', 'wnc_torob_tracking_nonce');
        ...
        if ($wc_status === WNC_Torob_WC_Status_Enum::COMPLETED) {
            $status_group = WNC_Torob_Status_Enum::SHIPPED;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::PROCESSING) {
            $status_group = WNC_Torob_Status_Enum::PROCESSING;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::PENDING) {
            $status_group = WNC_Torob_Status_Enum::WAITING_FOR_USER_PAYMENT;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::ON_HOLD) {
            $status_group = WNC_Torob_Status_Enum::WAITING_FOR_SHOP;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::CANCELLED && !$is_paid) {
            $status_group = WNC_Torob_Status_Enum::CANCELED_UNPAID;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::CANCELLED && $is_paid) {
            $status_group = WNC_Torob_Status_Enum::CANCELED_PAID;
        } elseif ($wc_status === WNC_Torob_WC_Status_Enum::REFUNDED) {
            $status_group = WNC_Torob_Status_Enum::CANCELED_PAID;
        }
		...
		<div class="order_data_column" style="padding: 0;">
			<?php if ($status_group === WNC_Torob_Status_Enum::SHIPPED): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_tracking_code">کد رهگیری:</label>
					<input type="text"
						   id="wnc_torob_tracking_code"
						   name="wnc_torob_tracking_code"
						   class="short"
						   style="width: 100%;"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_carrier">نام کالارسان:</label>
					<input type="text"
						   id="wnc_torob_carrier"
						   name="wnc_torob_carrier"
						   class="short"
						   style="width: 100%;"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_shipping_date">تاریخ ارسال:</label>
					<input type="text"
						   id="wnc_torob_shipping_date"
						   name="wnc_torob_shipping_date"
						   class="short"
						   style="width: 100%;"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_tracking_url">لینک پیگیری (در صورت امکان):</label>
					<input type="text"
						   id="wnc_torob_tracking_url"
						   name="wnc_torob_tracking_url"
						   class="short"
						   style="width: 100%;"
			...
			<?php elseif ($status_group === WNC_Torob_Status_Enum::PROCESSING): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_processing_stage">مرحله فعلی پردازش:</label>
					<input type="text"
						   id="wnc_torob_processing_stage"
						   name="wnc_torob_processing_stage"
						   class="short"
						   style="width: 100%;"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_estimated_shipping_date">تاریخ تخمینی ارسال:</label>
					<input type="text"
						   id="wnc_torob_estimated_shipping_date"
						   name="wnc_torob_estimated_shipping_date"
						   class="short"
						   style="width: 100%;"
			...
			<?php elseif ($status_group === WNC_Torob_Status_Enum::WAITING_FOR_USER_PAYMENT): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_payment_deadline">اعلام عدم پرداخت / مهلت یا راهنمای پرداخت:</label>
					<textarea id="wnc_torob_payment_deadline"
							  name="wnc_torob_payment_deadline"
							  rows="3"
							  style="width: 100%;"
			...
			<?php elseif ($status_group === WNC_Torob_Status_Enum::WAITING_FOR_SHOP): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_review_stage">اعلام در انتظار تایید فروشگاه بودن سفارش / توضیح کوتاه درباره مرحله بررسی:</label>
					<textarea id="wnc_torob_review_stage"
							  name="wnc_torob_review_stage"
							  rows="3"
							  style="width: 100%;"
			...
			<?php elseif ($status_group === WNC_Torob_Status_Enum::CANCELED_UNPAID): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_cancel_reason">دلیل لغو:</label>
					<textarea id="wnc_torob_cancel_reason"
							  name="wnc_torob_cancel_reason"
							  rows="2"
							  style="width: 100%;"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_payment_note">ذکر عدم انجام پرداخت:</label>
					<input type="text"
						   id="wnc_torob_payment_note"
						   name="wnc_torob_payment_note"
						   class="short"
						   style="width: 100%;"
			...
			<?php elseif ($status_group === WNC_Torob_Status_Enum::CANCELED_PAID): ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_cancel_reason">دلیل لغو:</label>
					<textarea id="wnc_torob_cancel_reason"
							  name="wnc_torob_cancel_reason"
				...
				<p class="form-field form-field-wide">
					<label for="wnc_torob_refund_status">وضعیت بازگشت وجه:</label>
					<input type="text"
						   id="wnc_torob_refund_status"
						   name="wnc_torob_refund_status"
						   class="short"
						   style="width: 100%;"
			...
			<?php else: ?>
				<p class="form-field form-field-wide">
					<label for="wnc_torob_status_explanation">توضیحات:</label>
					<textarea id="wnc_torob_status_explanation"
							  name="wnc_torob_status_explanation"
							  rows="4"
							  style="width: 100%;"
			...
			<p class="form-field form-field-wide" style="border-top: 1px solid #ddd; padding-top: 10px; margin-top: 10px;">
				<label for="wnc_torob_custom_explanation">توضیحات اضافی اختیاری:</label>
				<textarea id="wnc_torob_custom_explanation"
						  name="wnc_torob_custom_explanation"
						  rows="4"
						  style="width: 100%;"
    ...
    public function save_torob_tracking_meta_box(int $post_id, $post): void
    {
        ...
        if (
            !array_key_exists('wnc_torob_tracking_nonce', $_POST)
            || !wp_verify_nonce($_POST['wnc_torob_tracking_nonce'], 'wnc_torob_tracking_save')
        ) {
            return;
        }
        ...
        $fields = [
            'wnc_torob_tracking_code' => self::META_TRACKING_CODE,
            'wnc_torob_carrier' => self::META_CARRIER,
            'wnc_torob_shipping_date' => self::META_SHIPPING_DATE,
            'wnc_torob_tracking_url' => self::META_TRACKING_URL,
            'wnc_torob_processing_stage' => self::META_PROCESSING_STAGE,
            'wnc_torob_estimated_shipping_date' => self::META_ESTIMATED_SHIPPING_DATE,
            'wnc_torob_payment_deadline' => self::META_PAYMENT_DEADLINE,
            'wnc_torob_review_stage' => self::META_REVIEW_STAGE,
            'wnc_torob_cancel_reason' => self::META_CANCEL_REASON,
            'wnc_torob_payment_note' => self::META_PAYMENT_NOTE,
            'wnc_torob_refund_status' => self::META_REFUND_STATUS,
            'wnc_torob_status_explanation' => self::META_STATUS_EXPLANATION,
            'wnc_torob_custom_explanation' => self::META_CUSTOM_EXPLANATION
        ];
        ...
        foreach ($fields as $post_key => $meta_key) {
            ...
            if ($post_key === 'wnc_torob_tracking_url') {
