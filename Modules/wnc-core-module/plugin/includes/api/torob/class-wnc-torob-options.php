...
final class WNC_Torob_Options
{
    ...
    public const PRODUCT_PAGE_WEBHOOK_PROCESSING_LOCK_OPTION = 'wnc_torob_product_webhook_processing_lock';
    public const PRODUCT_PAGE_WEBHOOK_RUNNER_LAST_STARTED_AT_OPTION = 'wnc_torob_product_webhook_last_runner_started_at';
    public const PRODUCT_PAGE_WEBHOOK_RUNNER_LAST_COMPLETED_AT_OPTION = 'wnc_torob_product_webhook_last_runner_completed_at';
    public const PRODUCT_PAGE_WEBHOOK_RUNNER_LOCK_OPTION = 'wnc_torob_product_webhook_runner_lock';
    public const REPORTED_VERSION_OPTION = 'wnc_torob_plugin_reported_version';
