# Accounting module (ERP + Moadian + Hesabfa + Payroll/Tamin)
...
- Insurance ceiling + 7/20/3, cumulative tax brackets
- Official Tamin occupations lookup (`data/tamin-jobs.csv.gz`)
- Printable A4 payslip + decree; employee self-service `/accounting/my-payroll`
