...
const NAV_MODULE_ID_ALIASES: Record<string, string> = {
  ...
  'analytics-module-commerce': 'analytics-commerce',
  'analytics-module-compare': 'analytics-compare',
  'analytics-module-seo': 'analytics-seo',
  'analytics-module-support': 'analytics-support',
  'analytics-module-content': 'analytics-content',
  'analytics-module-month-summary': 'analytics-month-summary',
