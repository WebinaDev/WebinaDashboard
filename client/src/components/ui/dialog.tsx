...
import { RemoveScrollGate } from "@/lib/remove-scroll-gate"
...
function DialogContent({
  ...
  return (
    <RemoveScrollGate allowBodyScroll>
      <DialogPortal data-slot="dialog-portal">
        ...
        >
          ...
          {showCloseButton && (
            ...
            >
              <XIcon />
              <span className="sr-only">{i18n.t("a11y.close")}</span>
            </DialogPrimitive.Close>
          )}
        </DialogPrimitive.Content>
      </DialogPortal>
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close asChild>
          <Button variant="outline">{i18n.t('a11y.close')}</Button>
        </DialogPrimitive.Close>
      )}
    </div>
  )
